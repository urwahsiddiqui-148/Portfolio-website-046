...
export const Footer = () => {
  return <footer className="py-12 border-t border-border relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          duration: 0.5
            ...
            <span className="text-2xl font-bold gradient-text">Amina Ali</span>
          ...
          delay: 0.1
            ...
            return <motion.a key={social.name} href={social.url} target="_blank" rel="noopener noreferrer" whileHover={{
              scale: 1.1,
              y: -2
