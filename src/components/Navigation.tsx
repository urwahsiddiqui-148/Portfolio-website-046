...
const navItems: NavItem[] = [
  ...
  { label: 'Languages', href: '#languages', icon: <Languages className="w-4 h-4" /> },
  { label: 'Volunteering', href: '#volunteering', icon: <Heart className="w-4 h-4" /> },
    ...
    <>
      <motion.nav
        ...
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrolled
            ? 'bg-background/80 backdrop-blur-xl border-b border-border/50 shadow-lg shadow-glow-purple/5'
            : 'bg-transparent'
        }`}
      >
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            >
              <span className="text-xl font-bold gradient-text">Amna</span>
            ...
            <motion.button
              ...
              className="lg:hidden p-2 rounded-lg bg-muted/50 border border-border hover:border-primary/50 transition-colors"
            >
